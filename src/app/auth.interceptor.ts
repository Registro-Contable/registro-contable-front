...
export class AuthInterceptor implements HttpInterceptor {
  ...
  constructor(private httpClient: HttpClient, private authService: AuthService, private authApiClient: AuthApiClientService, private router: Router) { }

  intercept(req: HttpRequest<unknown>, next: HttpHandler): Observable<HttpEvent<any>> {
    let token = this.authService.credentials?.access_token;
